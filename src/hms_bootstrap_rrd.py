...
if __name__ == '__main__':
    # set up args
    parser = argparse.ArgumentParser(description='Host Monitoring Station RRD Database Bootstrap Tool')
    parser.add_argument('--dir', type=str, required=True, help='RRD database directory')
    parser.add_argument('--step', type=str, required=False, default='1m', help='RRD database step (default: 1m)')
